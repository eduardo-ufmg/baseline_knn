...
class KNNProfiler:
    ...
    def full_profile(self, func: Callable, name: str, *args, **kwargs) -> dict:
        ...
        with open(summary_file, 'w') as f:
            ...
            f.write(f"Memory Delta RSS: {memory_stats['memory_stats']['delta_rss_mb']:.2f} MB\n")
    ...
    def benchmark_comparison(self, functions_dict: dict, iterations: int = 5, *args, **kwargs):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", default="profiling/results", help="Output directory")
    ...
    if args.test:
        ...
        print(f"Memory delta: {results['memory_stats']['memory_stats']['delta_rss_mb']:.2f} MB")
    else:
