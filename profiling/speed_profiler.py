...
class SpeedProfiler:
    ...
    def profile_with_cprofile(self, func: Callable, filename: str, *args, **kwargs):
    ...
    def profile_with_line_profiler(self, func: Callable, *args, **kwargs):
...
def profile_decorator(output_dir: str = "profiling/results"):
...
def line_profile_decorator(func: Callable) -> Callable:
    """Decorator to profile function with line_profiler."""
    if not LINE_PROFILER_AVAILABLE:
        return func
...
if __name__ == "__main__":
    ...
    if args.test or args.benchmark:
        ...
        print("Speed profiling utilities loaded. Use --test or --benchmark to run tests.")
